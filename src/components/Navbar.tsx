...
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="flex items-center justify-between h-16">
//             {/* Left side: Logo and Hamburger Icon */}
//             <div className="flex items-center space-x-8">
//               <div className="md:hidden flex items-center">
//                 <button onClick={toggleMenu} className="text-white">
//                   <svg
...
//           {/* Mobile Menu */}
//           {isMenuOpen && (
//             <div className="md:hidden mt-2 bg-black text-white">
//               <Link
//                 to="/"
...
//                   <button
//                     onClick={() => navigate("/signup")}
//                     className="block px-4 py-2 hover:bg-orange-400 hover:text-black transition-colors"
//                   >
//                     Sign Up
//                   </button>
//                 </>
    ...
    <GoogleOAuthProvider clientId="your-google-client-id">
      <nav className="bg-black text-white shadow-lg fixed w-full top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Mobile Menu */}
          {isMenuOpen && (
            <div className="md:hidden mt-2 bg-black text-white overflow-hidden">
              <Link
                to="/"
                className="block px-4 py-2 hover:text-orange-500 transition-colors"
                onClick={toggleMenu}
